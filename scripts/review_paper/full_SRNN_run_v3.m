function [t_out, S_out, params, lya_results, plot_data] = full_SRNN_run_v3(u_ex_scale, n_a_E, n_b_E, level_of_chaos, rng_seeds, save_dir, save_figs, save_workspace, note, time_config)
