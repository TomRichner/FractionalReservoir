function cfg = numerics_verification_test_config()
% NUMERICS_VERIFICATION_TEST_CONFIG The numerics-verification stage alone, at 'fast'.
%
%   cfg = numerics_verification_test_config();
%   numerics_verification_test_run          % runs the stage, then the two figures
%
...
%
% See also: numerics_verification_test_run, run_numerics_verification,
...
cfg.run_dir  = 'data/numerics_verification_test';   % the stage writes <run_dir>/numerics_verification
