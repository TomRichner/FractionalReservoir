% TOPK_MED_RUN Single vs multi timescale, self-contained.
%
%   Open this file and press Run. setup_paths is called on the first line.
%
% Every setting comes from topk_med_config(), which states
...
%   run_mode  medium
%   run_dir   data/topk_med
%   fig_root  figs/topk_med
%
...
%
% RERUNNING REQUIRES DELETING data/topk_med FIRST.
% run_all_paper_analyses refuses a run directory that is not absent or empty.
%
% See also: topk_med_config, run_all_paper_analyses,
...
fprintf('\n========================================================\n');
fprintf('SINGLE vs MULTI TIMESCALE (top-K, medium) RUN COMPLETE\n');
