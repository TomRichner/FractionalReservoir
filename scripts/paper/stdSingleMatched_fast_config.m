function cfg = stdSingleMatched_fast_config()
% STDUSAGE_FAST_CONFIG The STD strength-matched (single-strengthened) network at 'fast', every analysis.
%
%   run_dir = run_all_paper_analyses(stdSingleMatched_fast_config());
%   results = make_all_paper_figures(stdSingleMatched_fast_config());
%
...
%
% RERUNNING: delete data/stdsinglematched_fast first.
% run_all_paper_analyses refuses a run directory that is not absent or empty.
%
% See also: stdSingleMatched_fast_run, run_all_paper_analyses,
...
cfg.preset_name = 'celltype_pairs_sfaEI_Sc0p2sig0p1_noise0p025_dualStdSingleMatched_3cond_mu8p25';
cfg.run_mode    = 'fast';

%% Where things land -- both fixed, so this cannot touch any other run
cfg.run_dir  = 'data/stdsinglematched_fast';   % analyses write, figures read
cfg.fig_root = 'figs/stdsinglematched_fast';   % overwritten in place
