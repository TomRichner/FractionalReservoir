function cfg = single_multi_TS_independent_med_config()
% SINGLE_MULTI_TS_INDEPENDENT_MED_CONFIG single_multi_TS_independent at 'medium'.
%
%   run_dir = run_all_paper_analyses(single_multi_TS_independent_med_config());
%   results = make_all_paper_figures(single_multi_TS_independent_med_config());
%
...
%
% RERUNNING: delete data/single_multi_TS_independent_med first.
% run_all_paper_analyses refuses a run directory that is not absent or empty.
%
% See also: single_multi_TS_independent_med_run, run_all_paper_analyses,
...
cfg.run_dir  = 'data/single_multi_TS_independent_med';   % analyses write, figures read
cfg.fig_root = 'figs/single_multi_TS_independent_med';   % overwritten in place
