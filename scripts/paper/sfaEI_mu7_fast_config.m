function cfg = sfaEI_mu7_fast_config()
% SFAEI_MU7_FAST_CONFIG The mu = 7 network (SFA on E and I, per-neuron S_c, SFA spread 0.25, no external input) at 'fast', every analysis, MC noise-free.
%
%   run_dir = run_all_paper_analyses(sfaEI_mu7_fast_config());
%   results = make_all_paper_figures(sfaEI_mu7_fast_config());
%
...
%
% RERUNNING: delete data/sfaEI_mu7_fast first.
% run_all_paper_analyses refuses a run directory that is not absent or empty.
%
% See also: sfaEI_mu7_fast_run, run_all_paper_analyses,
...
cfg.run_dir  = 'data/sfaEI_mu7_fast';   % analyses write, figures read
cfg.fig_root = 'figs/sfaEI_mu7_fast';   % overwritten in place
...
cfg.mc_preset            = 'celltype_pairs_sfaEI_Sc0p2sig0p1_tauSpread0p25_noStim_noise0_dualStd_3cond_mu7';
...
cfg.local_lyapunov_preset = 'celltype_pairs_sfaEI_Sc0p2sig0p1_tauSpread0p25_steps5s_noise0p025_dualStd_3cond_mu7';
