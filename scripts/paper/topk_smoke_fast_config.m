function cfg = topk_smoke_fast_config()
% TOPK_SMOKE_FAST_CONFIG single_multi_TS_independent at 'medium'.
%
%   run_dir = run_all_paper_analyses(topk_smoke_fast_config());
%   results = make_all_paper_figures(topk_smoke_fast_config());
%
...
%
% RERUNNING: delete data/topk_smoke_fast first.
% run_all_paper_analyses refuses a run directory that is not absent or empty.
%
% See also: topk_smoke_fast_run, run_all_paper_analyses,
...
cfg.run_dir  = 'data/topk_smoke_fast';   % analyses write, figures read
cfg.fig_root = 'figs/topk_smoke_fast';   % overwritten in place
