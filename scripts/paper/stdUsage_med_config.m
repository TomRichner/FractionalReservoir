function cfg = stdUsage_med_config()
% STDUSAGE_MED_CONFIG The STD strength-matched (usage) network at 'medium', every analysis.
%
%   run_dir = run_all_paper_analyses(stdUsage_med_config());
%   results = make_all_paper_figures(stdUsage_med_config());
%
...
%
% RERUNNING: delete data/stdusage_med first.
% run_all_paper_analyses refuses a run directory that is not absent or empty.
%
% See also: stdUsage_med_run, run_all_paper_analyses,
...
cfg.run_dir  = 'data/stdusage_med';   % analyses write, figures read
cfg.fig_root = 'figs/stdusage_med';   % overwritten in place
