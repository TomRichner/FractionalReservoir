...
if use_parallel
    parfor s = 1:n_seeds
        seed_results{s} = run_one_seed(s, seed_offset, n, f, indegree, F, phi, phi_deriv, ...
...
%  LOCAL FUNCTIONS
%  ======================================================================
function res = run_one_seed(s, seed_offset, n, f, indegree, F, phi, phi_deriv, S_a, S_c, ...
    ...
    model = SRNNModel2( ...
        ...
        'mu_E_tilde', 3*F, 'mu_I_tilde', -4*F, ...
        'sigma_E_tilde', 1*F, 'sigma_I_tilde', 1*F, ...
        'level_of_chaos', 1.0, ...
