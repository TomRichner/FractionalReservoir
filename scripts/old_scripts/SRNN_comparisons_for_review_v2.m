...
time_config.T_range = [-20, 60];
time_config.T_plot = [0, 60];
...
[~, ~, params_1, lya_1, plot_data_1] = full_SRNN_run_v2(u_ex_scale, n_a_E, n_b_E, level_of_chaos, rng_seeds, save_dir, save_figs, save_workspace, note, time_config);
...
fprintf('Running SRNN with u_ex_scale=%g, n_a_E=%d, n_b_E=%d, level_of_chaos=%g\n', u_ex_scale, n_a_E, n_b_E, level_of_chaos);
clear_SRNN_persistent(); 
[~, ~, params_4, lya_4, plot_data_4] = full_SRNN_run_v2(u_ex_scale, n_a_E, n_b_E, level_of_chaos, rng_seeds, save_dir, save_figs, save_workspace, note, time_config);
...
if save_figs
    ...
    save_name_base = 'combined_comparison_v2';
