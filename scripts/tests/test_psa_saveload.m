...
% The nonlinearity is recorded as a NAME, not a handle: activation_function is
% Dependent, so it is excluded, and what is captured compares exactly.
all_passed = check('captures the activation as plain data', ...
