...
stages = { ...
    ...
    'run_numerics_verification',   @() run_numerics_verification('run_mode', 'no_such_mode'); ...
    'run_lyapunov_spectrum',       @() run_lyapunov_spectrum('run_mode', 'no_such_mode'); ...
    'run_transient_gain',          @() run_transient_gain('run_mode', 'no_such_mode'); ...
    'run_local_lyapunov',          @() run_local_lyapunov('run_mode', 'no_such_mode'); ...
