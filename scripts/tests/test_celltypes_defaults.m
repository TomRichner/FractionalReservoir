...
model = SRNNModelCellTypes('fs',500, ...
    'T_range',[0 20], ...
    'n', 500, 'lya_method', 'benettin', ...
    'S_a', 0.9, 'S_c', 0.4, ...
    'activation_function', @(x) SRNNModelBase.piecewiseSigmoid(x, 0.9, 0.35, 1), ...
    'activation_function_derivative', @(x) SRNNModelBase.piecewiseSigmoidDerivative(x, 0.9, 0.35, 1));
