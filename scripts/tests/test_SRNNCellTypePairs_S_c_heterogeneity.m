...
m = tiny_model('n', 30, 'indegree', 10, 'tau_a', {log_ladder(0.25, 10, 2), log_ladder(0.25, 10, 1), []}, ...
    'synapse_config', sc, ...
    'mu_S_c', [0.4 0.1 -0.2], 'sigma_S_c', [0.1 0.1 0.1]);
m.build();
params = m.get_params();
...
run_args = {'T_range', [0 2], 'fs', 200, 'ode_solver', 'rk4', ...
    'lya_method', 'benettin', 'lya_T_interval', [0.5 2], 'tau_a', {log_ladder(0.25, 10, 2), log_ladder(0.25, 10, 1), []}};
...
defaults = {'n', 30, 'indegree', 10, ...
    ...
    'T_range', [0 0.5], 'fs', 200, 'ode_solver', 'rk4', 'lya_method', 'none'};
