...
m = SRNNModel2('S_a', d.S_a, 'S_c', d.S_c);
all_passed = check('activation handles match the preset''s own S_a/S_c', ...
    abs(d.activation_function(0.5) - SRNNModel2.piecewiseSigmoid(0.5, m.S_a, m.S_c)) < 1e-15) ...
    && all_passed;
