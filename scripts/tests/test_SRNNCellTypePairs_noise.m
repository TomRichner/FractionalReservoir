...
ou = SRNNCellTypePairs('n', 180, 'indegree', 20, 'n_cellTypes', 3, ...
    ...
    'n_a', [0 0 0], 'level_of_chaos', 0, 'u_ex_scale', 0, ...
...
a = pairs('sigma_u_noise', 0, 'ode_solver', 'euler', 'n_a', [2 1 1]);
b = pairs('sigma_u_noise', 0.5, 'ode_solver', 'euler', 'n_a', [2 1 1]);
a.build(); evalc('a.run();');
b.build(); evalc('b.run();');
...
q = pairs('sigma_u_noise', 0.2, 'n', 9, 'indegree', 4, 'n_a', [0 0 0], ...
