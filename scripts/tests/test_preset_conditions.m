...
% Scoped to an EXPLICIT list, the presets that are variants of one network
% and meant to be lined up regime for regime. Not in it: the figure presets
% (bursting, single-neuron, sompolinsky), which are different networks with
% their own ladders; and the sfaEI preset, whose sfa1_std1 / sfa3_std2 put
% SFA on I as well as E by design -- the timescale COUNTS still match the
% names, but the physics is deliberately not the other presets'. A new paper
% preset must be added here to be covered, which is the point of a list.
fprintf('\n-- a regime name is one struct across the paper presets --\n');
paper_presets = {'celltype_pairs_Sc0p2_noise0p025_dualStd_3cond', ...
...
names = {'celltype_pairs_Sc0p2_noise0p025_dualStd_3cond', ...
         ...
         'celltype_pairs_sfaEI_Sc0p2sig0p1_tauSpread0p05_noise0p025_dualStd_3cond_mu8p25', 'bursting_pairs', ...
         'sompolinsky_pairs', 'single_neuron_stf', 'single_neuron_dualStd', 'single_neuron_mu7revised', 'single_neuron_mu7revisedAgain', 'single_neuron_mu7revisedMedium', ...
