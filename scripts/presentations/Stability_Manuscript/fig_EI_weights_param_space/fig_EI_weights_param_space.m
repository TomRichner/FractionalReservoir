...
if cfg.save
    ...
    write_figure_readme(out_dir, struct( ...
        ...
        'notes',  {{['WHY NOT f_E. Its sibling fig_EI_param_space colours by the ' ...
                   ...
                   ['COLOUR LIMITS are fixed at 1:10 to 10:1 ([1/11, 10/11]) ' ...
                    'rather than taken from the data, so the bar means the same ' ...
                    'thing in every run -- with a randomly subsampled grid, ' ...
                    'derived limits depend on which networks happened to be ' ...
                    'drawn. They were briefly 1:19 to 19:1, which covered nearly ' ...
                    'the whole measured spread but spent most of the colormap on ' ...
                    'a few extreme networks and flattened the contrast across ' ...
                    'the bulk near 1:1. Networks beyond 1:10 or 10:1 clamp to ' ...
                    'the end colours and so read as "at least 10:1" rather than ' ...
                    'showing how far past it they go; ' ...
                    'load_and_make_unit_histograms warns with the count.'], ...
