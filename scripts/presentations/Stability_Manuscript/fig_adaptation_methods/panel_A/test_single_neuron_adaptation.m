...
base_args = { ...
    ...
    'activation_function', @(x) SRNNModel2.piecewiseSigmoid(x, 1.0, 0.35), ...
    'activation_function_derivative', @(x) SRNNModel2.piecewiseSigmoidDerivative(x, 1.0, 0.35), ...
    'tau_b_E_rec', 2};
