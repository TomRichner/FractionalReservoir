Stability_Manuscript figure: Parameter-space distributions (allStd2)
==================================================================

Generated: 14-Aug-2026 12:55:52
By script: Fig_param_space_allStd2.m
...
SOURCE RUN
  ...
  param_space subfolder(s) used:
    param_space_test_refactor_nLevs_4_aug_14_26_03_03

FIGURE PRODUCED (in this folder)
  Fig_ParamSpace_allStd2.png / .svg / .fig

READING THIS FIGURE
  The LLE histogram range is fixed at [-1.5, 1.5] inside
  ParamSpaceAnalysis2.plot and cannot be set from this script. On this
  preset the param-space LLEs span roughly -10 to +4.7, so the outermost
