classdef SRNNModel < handle
    ...
    properties (SetAccess = private)
        ...
        mu_I                        % Mean inhibitory weight (computed)
    ...
    methods
        function build(obj)
            ...
            %   2. Creates the weight matrix W using create_W_matrix()
            %   3. Scales W based on level_of_chaos
            ...
            % Compute G_stdev if not set
            if isempty(obj.G_stdev)
                obj.G_stdev = 1 / sqrt(obj.indegree);
            end
            ...
            % Create params struct for create_W_matrix
            params_W = obj.get_params();
            
            % Create W matrix
            [W_raw, ~, ~, ~] = create_W_matrix(params_W);
        ...
        function run(obj)
            ...
            % Clear persistent variables in SRNN_reservoir
            clear_SRNN_persistent();
            
            % Get params struct for ODE function
            ...
            % Define RHS function
            rhs = @(t, S) SRNN_reservoir(t, S, obj.t_ex, obj.u_ex, params);
        ...
        function compute_lyapunov(obj)
            ...
            % Define RHS function for Lyapunov computation
            rhs = @(t, S) SRNN_reservoir(t, S, obj.t_ex, obj.u_ex, params);
        ...
        function params = get_params(obj)
            ...
            % by functions like SRNN_reservoir, create_W_matrix, etc.
    ...
    methods (Access = private)
        ...
        function compute_derived_params(obj)
            % COMPUTE_DERIVED_PARAMS Calculate n_E, n_I, indices, N_sys_eqs, mu_I
