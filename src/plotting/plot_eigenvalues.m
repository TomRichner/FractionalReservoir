...
% See also: plot_lyapunov, plot_SRNN_tseries
    ...
    % Scatter plot of eigenvalues on complex plane (empty black circles)
    scatter(real(eigenvalues), imag(eigenvalues), 36, 'MarkerEdgeColor', [0 0 0], 'MarkerFaceColor', 'white');
