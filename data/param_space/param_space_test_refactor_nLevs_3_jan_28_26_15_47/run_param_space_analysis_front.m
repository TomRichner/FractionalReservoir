...
psa.add_grid_parameter('E_W', [-0.5 0.5] ./ sqrt(N*alpha*(2-alpha)));  % Mean offset (scaled by 1/sqrt(n))
...
psa.model_defaults.mu_E_tilde = 3 * default_tilde_val;
psa.model_defaults.mu_I_tilde = -3 * default_tilde_val;
...
psa.model_defaults.c_E = 0.5/3;              % SFA strength
