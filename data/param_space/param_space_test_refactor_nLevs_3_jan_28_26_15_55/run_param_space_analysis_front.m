...
psa.model_defaults.mu_E_tilde = 4 * default_tilde_val;
psa.model_defaults.mu_I_tilde = -4 * default_tilde_val;
...
psa.model_defaults.tau_b_E_rel = 0.25;         % STD release time for E neurons
