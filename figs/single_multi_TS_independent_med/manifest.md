...
| Run mode | `medium` |
| Figure root | `C:\Users\m218089\Desktop\github_repos\FractionalReservoir\figs\single_multi_TS_independent_med` (configured) |
...
|---|---|---:|---:|---|
| `fig_introductory_concepts` | yes | 6 | 33.4 | ok |
| `fig_energy_landscape` | -- | 3 | 2.0 | ok |
| `fig_example_timeseries` | yes | 3 | 23.1 | ok |
| `fig_FI_curve` | yes | 3 | 2.2 | ok |
| `fig_adaptation_methods` | yes | 3 | 9.4 | ok |
| `fig_adaptation_methods_stf` | -- | 3 | 19.0 | ok |
| `fig_SFA_steady_state` | -- | 3 | 2.2 | ok |
| `fig_STD_steady_state` | -- | 3 | 6.5 | ok |
| `fig_stim_engages_adaptation` | yes | 9 | 46.2 | ok |
| `fig_sensitivity_analysis_allStd` | yes | 12 | 83.9 | ok |
| `fig_sensitivity_medians` | -- | 6 | 9.7 | ok |
| `fig_param_space_allStd` | yes | 3 | 34.4 | ok |
| `fig_EI_param_space` | yes | 3 | 7.1 | ok |
| `fig_EI_weights_param_space` | yes | 3 | 17.8 | ok |
| `fig_sfa_EOC_allStd` | yes | 3 | 1.1 | ok |
| `fig_memory_capacity` | yes | 3 | 5.2 | ok |
| `fig_memory_capacity_example` | yes | 3 | 3.0 | ok |
| `fig_eig_heatmap` | -- | 3 | 3.3 | ok |
| `fig_dc_lle` | -- | 3 | 2.4 | ok |
| `doc_tables` | yes | 4 | 0.4 | ok |
